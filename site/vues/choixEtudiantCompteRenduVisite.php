...
<?php
    ...
    if(isset($_SESSION['identifiant']) && $_SESSION['role'] == 3) {
?>
    ...
    <body> <!-- C'est la structure initale du site -->
        ...
        <div class="bloc_page"> <!-- C'est la structure du site -->
            ...
            <div class="contenu"> <!-- C'est le contenu du site -->
                <h1> Compte-Rendu Visite</h1>
                <p>
                    <form method="post" action="../controleurs/controleurChoixEtudiantCompteRenduVisite.php">
                        <h2> Etudiant </h2>
                        <p>
                          <label for="choixEtudiant"> Choix Etudiant : </label>
                          <select name="choixEtudiant">
                            <?php
                              listeStagiaireTuteurEnseignant();
                            ?>
                          </select>
                        </p>
                        <p>
